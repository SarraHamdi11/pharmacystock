    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-l-4 border-teal-500">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Register a new patient in the pharmacy system</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-blue-800 font-semibold mb-2">Patient Registration Help</h3>
                    <ul class="text-blue-700 text-sm space-y-1">
                        <li>• All fields marked with <span class="text-red-500">*</span> are required</li>
                        <li>• Email address must be unique for each patient</li>
                        <li>• Phone number should include country code for international patients</li>
