    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-l-4 border-teal-500">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update medication information</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('products.update', $product) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" name="generic_name" id="generic_name" value="{{ old('generic_name', $product->generic_name) }}"
                                   class="w-full px-4 py-3 pl-10 border-2 border-gray-200 rounded-lg focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 bg-gray-50 focus:bg-white"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" name="code_bar" id="code_bar" value="{{ old('code_bar', $product->code_bar) }}"
                                   class="w-full px-4 py-3 pl-10 border-2 border-gray-200 rounded-lg focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 bg-gray-50 focus:bg-white"
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <div class="relative">
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Enter medication description and usage instructions">{{ old('description', $product->description) }}</textarea>
        ...
        <div class="mt-6 bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-blue-800 font-semibold mb-2">Current Medication Information</h3>
